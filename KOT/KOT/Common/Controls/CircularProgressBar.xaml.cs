...
namespace KOT.Common.Controls
{
    public partial class CircularProgressBar : UserControl
    {
        ...
        public static readonly DependencyProperty RateValueProperty =
            DependencyProperty.Register("RateValue", typeof(double), typeof(CircularProgressBar), new PropertyMetadata(0.0, UpdateValue));
        ...
        private static void UpdateValue(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            var value = Math.Truncate((double)e.NewValue * 100.0) / 100.0;
        ...
        private static readonly DependencyProperty ValueProperty =
            DependencyProperty.Register("Value", typeof(double), typeof(CircularProgressBar), null);
