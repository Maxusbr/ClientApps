...
namespace KOT.Common.Controls
{
    public sealed partial class DetailBudgetControl : UserControl
    {
        ...
        private void UserControl_LayoutUpdated(object sender, object e)
        {
            ...
            if (vm == null) return;
            GasButton.IsChecked = vm.SelectedCategoryId == 1;
            ParkingButton.IsChecked = vm.SelectedCategoryId == 2;
            CarwashButton.IsChecked = vm.SelectedCategoryId == 3;
            ShopButton.IsChecked = vm.SelectedCategoryId == 4;
            RashodButton.IsChecked = vm.SelectedCategoryId == 5;
        }
    }
}
