...
namespace DTCDev.Client.Cars.Service.Engine.Storage
{
    public class PIDConverter
    {
        public string GetPidInfo(string rw)
        {
            ...
            switch (data1[0])
            {
                case 0x00: return "Список поддерживаемых PID'ов (0-20)";
                case 0x01: return "Monitor status since DTCs cleared. (Includes malfunction indicator lamp (MIL) status and number of DTCs.)";
                case 0x02: return "Freeze DTC";
                case 0x03: return "Fuel system status";
                case 0x04: return "Расчетное значение нагрузки на двигатель";
                case 0x05: return "Температура охлаждающей жидкости";
                ...
                case 0x0A: return "Давление топлива (Fuel pressure)";
                case 0x0B: return "Давление во впускном коллекторе (абсолютное)";
                ...
                case 0x20: return "Список поддерживаемых PID'ов (21-40) (PIDs supported [21 - 40])";
                case 0x21: return "Дистанция, пройденная с зажженной лампой «проверь двигатель»";
                case 0x22: return "Fuel Rail Pressure (relative to manifold vacuum)";
                case 0x23: return "Fuel Rail Pressure (diesel, or gasoline direct inject)";
                ...
                case 0x2F: return "Уровень топлива (Fuel Level Input)";
                case 0x30: return "Количество прогревов со времени очистки кодов нейсправности (# of warm-ups since codes cleared)";
                case 0x31: return "Дистанция, пройденная со времени очистки кодов нейсправностей (Distance traveled since codes cleared)";
                case 0x32: return "Evap. System Vapor Pressure";
                case 0x33: return "Атмосферное давление (абсолютное) (Barometric pressure)";
                ...
                case 0x40: return "Список поддерживаемых PID'ов (41-60) (PIDs supported [41 - 60])";
                case 0x41: return "Monitor status this drive cycle";
                case 0x42: return "Напряжение контрольного модуля (Control module voltage)";
                case 0x43: return "Абсолютное значение нагрузки (Absolute load value)";
                case 0x44: return "Command equivalence ratio";
                case 0x45: return "Относительное положение дроссельной заслонки (Relative throttle position)";
                case 0x46: return "Температура окружающего воздуха (Ambient air temperature)";
                case 0x47: return "Абсолютное положение дроссельной заслонки B (Absolute throttle position B)";
                case 0x48: return "Абсолютное положение дроссельной заслонки C (Absolute throttle position C)";
                case 0x49: return "Положение педали акселератора D (Accelerator pedal position D)";
                case 0x4A: return "Положение педали акселератора E (Accelerator pedal position E)";
                case 0x4B: return "Положение педали акселератора F (Accelerator pedal position F)";
                case 0x4C: return "Commanded throttle actuator";
                case 0x4D: return "Время со включенной лампой «проверь двигатель» (Time run with MIL on)";
                case 0x4E: return "Время, прошедшее с момента очистки кодов неисправностей (Time since trouble codes cleared";
                case 0x4F: return "Maximum value for equivalence ratio, oxygen sensor voltage, oxygen sensor current, and intake manifold absolute pressure";
                case 0x50: return "Maximum value for air flow rate from mass air flow sensor";
                case 0x51: return "Тип топлива (Fuel Type)";
                ...
                case 0x59: return "Абсолютное давление на топливной рампе (Fuel rail pressure (absolute))";
                case 0x5A: return "Относительное положение педали акселератора (Relative accelerator pedal position)";
                case 0x5B: return "Заряд силовой батареи гибрида (Hybrid battery pack remaining life)";
                case 0x5C: return "Температура масла двигателя (Engine oil temperature)";
                case 0x5D: return "Регулирование момента впрыска (Fuel injection timing)";
                case 0x5E: return "Engine fuel rate	0";
                case 0x5F: return "Emission requirements to which vehicle is designed";
                case 0x60: return "Список поддерживаемых PID'ов (61-80) (PIDs supported [61 - 80])";
                case 0x61: return "Запрашиваемый момент двигателя (Driver's demand engine - percent torque)";
                case 0x62: return "Реальный момент двигателя (Actual engine - percent torque)";
                case 0x63: return "Исходный момент двигателя (Engine reference torque)";
